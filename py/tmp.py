...
for ci in clip_indices:
    pred = {'ClassName':AAL_CODE_dict[ci],'ClassName_German':AAL_CODE_dict_german[ci],'Datetime':dt_local(),'Datetime_2':dt_local_2(),'Confidence':float(np.max(clipwise_outputs))}
